...
export default function LastGames() {
    ...
    return (
        <section className="py-10 gap-2 text-chiaro bg-scuro items-center justify-center text-center px-4">
            <div className="col-span-2 flex flex-col items-center justify-center">
                <h2 className="text-4xl md:text-5xl font-bold text-bianco mb-4">Ultimi Giochi</h2>
                ...
                <div className="grid p-5">
                    ...
                    <div className="text-center flex items-center justify-center mt-12">
                        <ButtonUI link="/games" text="Vedi Tutti i Giochi" />
                    </div>
                </div>
            </div>
        </section>
