...
export default function GameCard({ title, image, genre, released }) {
  return (
    <div
      ...
      <div className="p-4 flex flex-col gap-3 ">
        ...
        <button className="self-center relative mt-3 text-sm mb-0 px-4 py-2 rounded-full bg-white text-[#1B1A30] font-semibold transition hover:bg-[#FF6F61] hover:text-white">
          Dettagli
        </button>
      </div>
    </div>
